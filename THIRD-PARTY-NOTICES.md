...
> Phase 0 stub. `cargo run -p xtask -- third-party-notices` regenerates this file.
> Phase 13 wires `cargo about generate` to expand the full notice list at every release.
