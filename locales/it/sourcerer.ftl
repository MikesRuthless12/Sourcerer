...
settings-ui-new-window-on-launch = Apri una nuova finestra all'avvio di Sourcerer
...
wizard-roots-hint = Aggiungi le cartelle o i volumi che vuoi far monitorare a Sourcerer. Potrai modificarli in seguito dalle impostazioni Indici.
...
wizard-locale-hint = Sourcerer è disponibile in 18 lingue. Potrai cambiarla in seguito.
...
# UI panel.
ui-hint = Tema, integrazione con area di notifica / barra dei menu, ricerca mentre digiti, densità delle righe. Parità diretta con voidtools-Everything più le aggiunte di Sourcerer contrassegnate con (+).
...
# Home panel.
home-hint = Valori predefiniti caricati all'avvio dell'app: ogni menu a discesa può mantenere «Usa ultimo valore» o fissare un valore. La visibilità delle lenti e i limiti dei risultati sono aggiunte di Sourcerer (+).
...
folders-section-extras = Extra di Sourcerer (+)
...
# File menu.
menu-file-hint = Contiene i comandi per lavorare con Sourcerer.
...
menu-edit-copy-as-bundle-ref = Copia come riferimento a un bundle Sourcerer
...
menu-help-help = Guida di Sourcerer
...
menu-help-website = Sito web di Sourcerer
...
section-sourcerer-extras = Extra di Sourcerer (+)
section-sourcerer-additions = Aggiunte di Sourcerer (+)
section-sourcerer-extensions = Estensioni di Sourcerer (+)
