...
settings-ui-new-window-on-launch = Neues Fenster beim Start von Sourcerer öffnen
...
# UI panel.
ui-hint = Design, Integration in Infobereich/Menüleiste, Suchen während der Eingabe, Zeilendichte. Direkte Übereinstimmung mit voidtools Everything sowie Sourcerer-Ergänzungen, gekennzeichnet mit (+).
...
# Home panel.
home-hint = Standardwerte werden beim App-Start geladen — jedes Dropdown kann auf „Letzten Wert verwenden“ bleiben oder einen festen Wert beibehalten. Lupensichtbarkeit/Ergebnisgrenzen sind Sourcerer-Ergänzungen (+).
...
# File menu.
menu-file-hint = Enthält Befehle für die Arbeit mit Sourcerer.
...
menu-edit-copy-as-bundle-ref = Als Sourcerer-Bundle-Referenz kopieren
