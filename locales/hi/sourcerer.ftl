...
settings-context-menu-send-to = Sourcerer को भेजें (पथ)
...
wizard-roots-hint = वे फ़ोल्डर या वॉल्यूम जोड़ें जिन्हें आप Sourcerer से देखना चाहते हैं। आप इसे बाद में अनुक्रमणिका सेटिंग से बदल सकते हैं।
...
# UI panel.
ui-hint = थीम, ट्रे / मेनू-बार एकीकरण, टाइप करते ही खोज, पंक्ति घनत्व। प्रत्यक्ष voidtools-Everything समानता के साथ (+) से चिह्नित Sourcerer अतिरिक्त सुविधाएँ।
...
# Home panel.
home-hint = ऐप लॉन्च पर लोड किए गए डिफ़ॉल्ट — हर ड्रॉपडाउन "अंतिम मान उपयोग करें" पर टिक सकता है या कोई स्थिर मान पिन कर सकता है। लेंस दृश्यता / परिणाम सीमाएँ Sourcerer अतिरिक्त सुविधाएँ हैं (+)।
...
# File menu.
menu-file-hint = Sourcerer के साथ काम करने के कमांड शामिल हैं।
...
menu-edit-copy-as-bundle-ref = Sourcerer Bundle संदर्भ के रूप में कॉपी करें
...
section-sourcerer-additions = Sourcerer अतिरिक्त सुविधाएँ (+)
