...
wizard-title = مرحبًا بك في Sourcerer
...
settings-ui-new-window-on-launch = فتح نافذة جديدة عند تشغيل Sourcerer
...
settings-context-menu-reveal = إظهار في Sourcerer
settings-context-menu-send-to = إرسال إلى Sourcerer (المسار)
...
settings-flists-format-srcb = حزمة Sourcerer (.srcb)
...
wizard-locale-hint = يتوفّر Sourcerer بـ 18 لغة. يمكنك التبديل لاحقًا.
...
# UI panel.
ui-hint = السمة، تكامل شريط المهام / شريط القوائم، البحث أثناء الكتابة، كثافة الصفوف. تطابق مباشر مع voidtools-Everything إضافةً إلى إضافات Sourcerer المميّزة بـ (+).
...
# Home panel.
home-hint = إعدادات افتراضية تُحمَّل عند تشغيل التطبيق — يمكن لكل قائمة منسدلة أن تلتزم بـ "استخدام آخر قيمة" أو تثبيت قيمة ثابتة. ظهور العدسات / حدود النتائج من إضافات Sourcerer (+).
...
menu-help-website = موقع Sourcerer
