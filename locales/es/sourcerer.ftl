...
settings-ui-new-window-on-launch = Abrir una ventana nueva al iniciar Sourcerer
...
settings-flists-format-srcb = Paquete de Sourcerer (.srcb)
...
wizard-roots-hint = Añade las carpetas o volúmenes que quieres que Sourcerer supervise. Puedes cambiarlo más adelante en la configuración de Índices.
...
wizard-locale-hint = Sourcerer está disponible en 18 idiomas. Puedes cambiarlo más adelante.
...
# UI panel.
ui-hint = Tema, integración con la bandeja / barra de menús, búsqueda mientras escribes, densidad de filas. Paridad directa con voidtools-Everything más las funciones añadidas de Sourcerer marcadas con (+).
...
# Home panel.
home-hint = Valores predeterminados cargados al iniciar la aplicación: cada menú desplegable puede mantener «Usar el último valor» o fijar un valor concreto. La visibilidad de las lentes y los límites de resultados son funciones añadidas de Sourcerer (+).
...
menu-edit-copy-as-bundle-ref = Copiar como referencia de paquete de Sourcerer
...
section-sourcerer-additions = Funciones añadidas de Sourcerer (+)
