//! Rust mirror of `apps/sourcerer-ui/src/lib/commands/menu_spec.ts`.
//!
...
pub fn menu_bar() -> Vec<RootSpec> {
    vec![
                ...
                NodeSpec::Submenu {
                    ...
                    children: vec![
                        ...
                        item(
                            ...
                            "Copy as Sourcerer Bundle reference",
                        ),
                    ],
                },
            ],
        ...
        RootSpec {
            ...
            children: vec![
                item_a("help.help", "Sourcerer Help", "F1"),
