//! `sourcerer://` URL protocol handler.
//!
//! Supported shapes:
//!   * `sourcerer://search?q=<query>&filter=<id>` — drops a query into
//!     the search bar and runs it.
//!   * `sourcerer://bundle/<encoded-path>` — bundle reference; Phase 11
