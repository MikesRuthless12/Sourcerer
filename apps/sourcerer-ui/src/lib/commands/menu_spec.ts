...
// `locales/<code>/sourcerer.ftl`. MenuBar.svelte calls
...
export const MENU_BAR: MenuRoot[] = [
    ...
    children: [
      ...
      { kind: "item", id: "edit.invert_selection", label: "Invert Selection", l10n: "menu-edit-invert-selection" },
      {
        ...
        children: [
          ...
          { kind: "item", id: "edit.advanced.copy_as_bundle_ref", label: "Copy as Sourcerer Bundle reference", l10n: "menu-edit-copy-as-bundle-ref" }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      { kind: "item", id: "help.help", label: "Sourcerer Help", l10n: "menu-help-help", accelerator: "F1" },
      ...
      { kind: "item", id: "help.website", label: "Sourcerer Website", l10n: "menu-help-website" },
      ...
      { kind: "separator" },
      { kind: "item", id: "help.about", label: "About Sourcerer…", l10n: "menu-help-about", accelerator: "Ctrl+F1" }
    ]
  }
];
