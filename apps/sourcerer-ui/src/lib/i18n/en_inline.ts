// Phase 11 inline en source. Mirrors locales/en/sourcerer.ftl; kept in sync
// by xtask i18n-lint. Phase 12 (TASK-098) replaces this with a build-time
// .ftl loader that reads the 18-locale set directly.
